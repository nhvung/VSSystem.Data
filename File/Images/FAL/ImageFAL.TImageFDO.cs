...
using VSSystem.Data.File.Images.FDO;

namespace VSSystem.Data.File.Images.FAL
{
    public class ImageFAL<TImageFDO> : IDataFAL<long, PositionObjectInFileDTO<long>, TImageFDO>
        where TImageFDO : ImageFDO
    {
        protected ImageFAL()
        {
        ...
        public override TImageFDO GetObject(long id, string shareDataFileFolderPath = "")
        {
            try
            {
        ...
        public override List<TImageFDO> GetObjects(List<long> ids, string shareDataFileFolderPath = "")
        {
            try
            {
