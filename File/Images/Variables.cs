...
namespace VSSystem.Data.File.Images
{
    public class Variables : Data.Variables
    {
        ...
        public static void InitFromIniFile(Func<string, string, string, string> readIniValueFunc, Func<string, string> descryptFunc, string configSection = "database_image_info")
        {
